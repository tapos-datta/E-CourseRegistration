                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="@if($checkStatus==0 || $checkStatus==1){{'active'}} <?php $checkStatus=0;?> @endif w3-light-orange"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">1/1</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==2){{'active'}}@endif  w3-light-orange"><a href="#tab_content2" role="tab" id="profile-tab"  data-toggle="tab" aria-expanded="false">1/2</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==3){{'active'}}@endif w3-light-orange"><a href="#tab_content3" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">2/1</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==5){{'active'}}@endif w3-light-orange"><a href="#tab_content4" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">2/2</a>
                                            </li>

                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content5" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">3/1</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content6" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">3/2</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content7" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">4/1</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content8" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">4/2</a>
                                            </li>
                                        </ul>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="@if($checkStatus==0 || $checkStatus==1){{'active'}} <?php $checkStatus=0;?> @endif w3-light-orange"><a href="#tab_content11" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">1/1</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==2){{'active'}}@endif  w3-light-orange"><a href="#tab_content12" role="tab" id="profile-tab"  data-toggle="tab" aria-expanded="false">1/2</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==3){{'active'}}@endif w3-light-orange"><a href="#tab_content13" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">2/1</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==5){{'active'}}@endif w3-light-orange"><a href="#tab_content14" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">2/2</a>
                                            </li>

                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content15" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">3/1</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content16" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">3/2</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content17" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">4/1</a>
                                            </li>
                                        </ul>
                                        <div id="myTabContent" class="tab-content">
