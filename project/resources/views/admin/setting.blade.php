                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="@if($checkStatus==0 || $checkStatus==1){{'active'}} <?php $checkStatus=0;?> @endif w3-light-orange"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Curriculum</a>
                                            </li>
                                            @if($role=='admin')
                                            <li role="presentation" class="@if($checkStatus==2){{'active'}}@endif  w3-light-orange"><a href="#tab_content2" role="tab" id="profile-tab"  data-toggle="tab" aria-expanded="false">Add syllabus</a>
                                            </li>
                                            @endif
                                            @if($role=='head' || $role=='admin')
                                            <li role="presentation" class="@if($checkStatus==3){{'active'}}@endif w3-light-orange"><a href="#tab_content4" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Offered Courses</a>
                                            </li>
                                            @endif
                                            @if($role=='admin')
                                            <li role="presentation" class="@if($checkStatus==5){{'active'}}@endif w3-light-orange"><a href="#tab_content5" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Department</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==6){{'active'}}@endif w3-light-orange"><a href="#tab_content6" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Course</a>
                                            </li>
                                            <li role="presentation" class="@if($checkStatus==7){{'active'}}@endif w3-light-orange"><a href="#tab_content7" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Batch Info</a>
                                            </li>
                                            @endif
                                        </ul>
                                                                ...
                                                                <table class="data table jambo_table table-striped no-margin">
                                                                    ...
                                                                    @foreach($offeredList as $offered)
                                                                        <tr>
                                                                            ...
                                                                            <td align="right"><button type="submit" class="btn btn-danger" id="deleteButton"  name="submit" onclick="return confirmChange();"> Delete</button></td>
                                                                            {!! Form::close()!!}
                                                                        </tr>
                                                                    @endforeach
                                                                    </tbody>
