...
class NotificationController extends Controller
{
    ...
    public function applyForRegistration(){
        ...
        if($check!=null && $role=='student' && $valid!=null && $isRegistered==null){
            ...
            $courses=DB::table('offered_course_list')->get();
    ...
    public function majorCourseAdd(){
        ...
        if($check!=null && $role=='student'&& $valid!=null && $isRegistered==null){
            ...
            $currentofferedId=DB::table('offered_courses')->where('SEMESTER_NAME',$studentOfCurrentSemester)->first();

            $offeredMajorCourseList=DB::table('offered_course_list')->where('OFFERED_ID',$currentofferedId->OFFERED_ID)->get();
//            return Session::get('listOfOfferedCourses');
    ...
    public function minorCourseAdd(){
        ...
        if($check!=null && $role=='student'&& $valid!=null && $isRegistered==null){
            ...
            $offeredMinorCourseList=DB::table('offered_course_list')->where('OFFERED_ID',$currentofferedId->OFFERED_ID)->get();
//            return Session::get('listOfOfferedCourses');
    ...
    public function dropAdvncCourseAdd(){
        ...
        if($check!=null && $role=='student'&& $valid!=null && $isRegistered==null){
            ...
            if($currentLevel+2<=4){
                ...
                $dropAdvanceofferedID=DB::table('offered_courses')->select('OFFERED_ID')
                        ->where('SEMESTER_NAME','!=',$currentSemester)
                        ->where('SEMESTER_NAME','<',$advanceNotAllow)->get();
    ...
    public function completeRegistration(Request $request){
        ...
        if($check!=null && $role=='student'&& $isRegistered==null){
            ...
            $dataCheck=DB::table('registration_process')->where('REG_NO',$reg_no)->first();
