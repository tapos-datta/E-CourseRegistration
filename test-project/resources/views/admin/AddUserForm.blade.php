                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4 col-md-offset-1 col-sm-12 col-xs-12 ">
                                        <input type="text" id="focus" name="fatherName" placeholder="FATHER NAME" class="form-control" required>
                                    </div>
                                    <div class="col-md-4 col-md-offset-2 col-sm-12 col-xs-12 ">
                                        <input type="text" id="focus" name="motherName" placeholder="MOTHER NAME" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-md-offset-2 col-sm-12 col-xs-12 ">
                                        ...
                                        <div class="col-md-7  col-sm-12 col-xs-12">
                                            <input type="date" id="focus1" name="birthday" min="2000-01-01" max="2099-01-01">
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6  col-sm-12 col-xs-12 ">
                                                    ...
                                                    <div class="col-md-8 col-sm-12 col-xs-12">
                                                        <div class="radio" >
                                                            ...
                                                            <label>
                                                                <input type="radio" class="flat" name="iCheck" value="teacher"> HEAD TEACHER
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="x_panel">
                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div style=" margin-bottom: 8.5%;"><br /></div>
                                            </div>
