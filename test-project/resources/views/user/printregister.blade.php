...
<body>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div  style="float: left; margin-left: 2.5%; margin-top: 3.5%;">
    ...
    <div class="row" style="clear:both">
        ...
        <div class="col-sm-10">
            <div class="col-sm-7">
                <p style="margin-left: 10%;margin-top: 5%">পরীক্ষার্থীর সাক্ষর :</p>
            </div>
            <div class="col-sm-5">
                <p>পরীক্ষা নিয়ন্ত্রকের সাক্ষর:</p>
                <p>তারিখ</p>
            </div>
        </div>
        <div class="col-sm-1">
        ...
        <div class="col-sm-10">
            <table cellspacing="0" style="margin-top: 1%">
                ...
                <tr>
                    ...
                    <td style="width:7.813em;">  ইংরেজি বড় বর্ণে :</td>
                    <td style="width:1.563em;height:1.5em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
    ...
    <div class="row" >
        ...
        <div class="col-sm-10">
            <table cellspacing="0" style="margin-top: 1.5%">
                <tbody>
                <tr>
                    <td style="width:7.813em;height:1.5em;"> পিতার নাম :</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
    ...
    <div class="row" >
        ...
        <div class="col-sm-10">
            <table cellspacing="0" style="margin-top: 1.5%">
                <tbody>
                <tr>
                    <td style="width:7.813em ;height:1.5em;">মাতার নাম:</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
                    <td style="width:1.563em;border:1px solid black;">&nbsp;</td>
