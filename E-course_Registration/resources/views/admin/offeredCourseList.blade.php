                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div>
                            <ul class="breadcrumb">
                                ...
                                <li><a href="{{ route('exam.session_data',array('session_month'=>$sessionMonth,'year'=>$year))}}">Offered courses in {{$year}}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table  id='datatable' class="table table-striped jambo_table table-bordered">
                                            ...
                                            <tr class="headings">
                                                ...
                                                <th class="column-title alignment">Category</th>
                                                <th class="column-title alignment">Type</th>
