...
$dropAdCourses=Session::get('DropAdvancedCourseList');
$offeredCourse=$dropAdCoursesList;
...
$studentOfCurrentLevel=Session::get('studentOfCurrentLevel');
?>
        <!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>List of drop/advance courses </title>
            ...
            <div class="">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                <h2>Drop/Advance Courses<small>Add to register form</small></h2>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table id='datatable-checkbox' class="table table-striped jambo_table table-bordered">
                                            ...
                                            <tbody>
                                            @if(sizeof($offeredCourse)>0)
                                                @foreach($offeredCourse as $offered)
                                                    @if($dropAdCourses!=null)
                                                        <?php $flag=0;?>
                                                        @foreach($dropAdCourses as $dropAd)
