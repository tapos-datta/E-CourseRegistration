                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            <div class="x_title">
                                ...
                                <div align="right">
                                    <a href="{{route('add.offered_course',array('session_month'=>$sessionMonth,'year'=>$year))}}" id="addButton">+ New Semester </a>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="x_content">
                                        <table  id='datatable-checkbox' class="table table-striped jambo_table table-bordered">
                                            <thead>
                                            <tr class="headings">
                                                <th class="column-title alignment">Student Session</th>
                                                <th class="column-title alignment">Syllabus Year</th>
                                            ...
                                            @foreach($offeredData as $offer)
                                                <tr>
                                                    <td class=" alignment">{{$offer->SESSION}}-{{$offer->SESSION+1}}</td>
